...
<div class="container" align="center">
    <h2>회원가입</h2>
    <div id='signform'>
    <form class='form_margin' action='signup.php' method='post'>
    <table align='center' border='0' width='400px' cellspacing='0' cellpadding='0'>
        ...
        <tr>
            ...
            <td width='50%' colspan='1'> 
                <input type='text' id='username' name='username' class='inph'>
            </td>
        </tr>
        <tr>
        	<td width='20%' colspan='1'> 
        ...
        <tr>
        	<td colspan='2' align='center' padding='0'> 
                <button class='button signin' width='100%' onclick="javascript:return validate();">회원가입</button>
            </td>
        </tr>
    	<tr>
           	<td colspan='3' align='center'> 
               <p align='center'>이미 계정이 있으면 <a href='signin_form.php'>로그인</a></p>
            </td>
        </tr>
    </table>
    </form>
